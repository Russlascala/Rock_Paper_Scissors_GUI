...
class RPSGame(Frame):
    ...
    def __init__(self):
        ...
        self._playerImg = PhotoImage(file = 'RPS/question.png')
        self._compImg = PhotoImage(file = 'RPS/question.png')
    ...
    def _computerGuess(self):
        ...
        self._computerImgFile = random.choice(['RPS/rock.png', 'RPS/paper.png', 'RPS/scissors.png'])
        self._compImg = PhotoImage(file = self._computerImgFile )
        self._choiceImgLabC["image"] = self._compImg
        if self._computerImgFile == 'RPS/rock.png':
            self._textLabelC["text"] = "Rock"
        elif self._computerImgFile == 'RPS/paper.png':
    ...
    def _choiceRock(self):
        self._computerGuess()
        self._playerImg = PhotoImage(file = 'RPS/rock.png')
        self._choiceImgLabP["image"] = self._playerImg
        self._textLabelP["text"] = "Rock"
        if self._computerImgFile == 'RPS/paper.png': 
            self._winnerLabel["text"] = "YOU LOOSE!"
            self._winnerLabel["fg"] = "red"
        elif self._computerImgFile == 'RPS/scissors.png':
    ...
    def _choicePaper(self):
        self._computerGuess()
        self._playerImg = PhotoImage(file = 'RPS/paper.png')
        self._choiceImgLabP["image"] = self._playerImg
        self._textLabelP["text"] = "Paper"
        if self._computerImgFile == 'RPS/scissors.png': 
            self._winnerLabel["text"] = "YOU LOOSE!"
            self._winnerLabel["fg"] = "red"
        elif self._computerImgFile == 'RPS/rock.png':
            self._winnerLabel["text"] = "YOU WIN!"
            self._winnerLabel["fg"] = "green"
        else: 
            self._winnerLabel["text"] = "ITS A TIE!"
    ...
    def _choiceScissors(self):
        self._computerGuess()
        self._playerImg = PhotoImage(file = 'RPS/scissors.png')
        self._choiceImgLabP["image"] = self._playerImg
