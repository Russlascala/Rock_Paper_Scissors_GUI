...
class RPSGame(Frame):
    ...
    def __init__(self):
        ...
        # Buttons for choice Rock Paper or Scissors
    ...
    def _computerGuess(self):
        # Gets random choice for the computer, outputs the image and label. 
    ...
    # Changes the image and label to rock, plays the game, and decides a winner  
    ...
    # Changes the image and label to paper, plays the game, and decides a winner 
    ...
    # Changes the image and label to scissors, plays the game, and decides a winner 
